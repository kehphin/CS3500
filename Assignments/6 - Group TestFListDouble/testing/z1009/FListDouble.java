public abstract class FListDouble {
    ...
    public int size () { return FListDouble.size (this); }
    public Double get (int n) { return FListDouble.get (this, n); }
    public FListDouble set (int n, Double y) {
        return FListDouble.set (this, n, y);
    }
...
class Add extends FListDouble {
	...
	if (FListDouble.isEmpty(l0))
	    ...
	    return "[ " + s0.toString() + ", " + 
		l0.toString().substring(1, l0.toString().length() - 1) + " ]";
    }
}
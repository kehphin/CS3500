...
/**
 * Basic test program for assignment 4.
 * @author Clinger
 * @author Schmidt
 */
    ...
    */
    private void accessors () {
	    ...
	    // Testing containsValue
            ...
            assertFalse ("containsValue5alice", f5.containsValue(alice));
            assertTrue ("containsValue5bob", f5.containsValue(bob));
            assertTrue ("containsValue5carol", f5.containsValue(carol));
            assertTrue ("containsValue7alice", f7.containsValue(alice));
            assertTrue ("containsValue7bob", f7.containsValue(bob));
            assertFalse ("containsValue7carol", f7.containsValue(carol));
            assertFalse ("containsValue7dave", f7.containsValue(dave));

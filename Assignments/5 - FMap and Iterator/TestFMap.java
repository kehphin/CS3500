...
/**
 * Basic test program for assignment 5.
 * @author Clinger
 * @author Schmidt
 */
public class TestFMap {
    ...
    private FMap<Integer,String> f8;// 
    ...
    */
    private void accessors () {
	    ...
	    // Testing containsValue
            ...
            assertTrue ("containsValue5alice", f5.containsValue(alice)); //Changed from Assignment 4 specs
            assertTrue ("containsValue5bob", f5.containsValue(bob));
            assertFalse ("containsValue5carol", f5.containsValue(carol)); //Changed from Assignment 4 specs
            assertFalse ("containsValue7alice", f7.containsValue(alice)); //Changed from Assignment 4 specs
            assertFalse ("containsValue7bob", f7.containsValue(bob)); //Changed from Assignment 4 specs
            assertFalse ("containsValue7carol", f7.containsValue(carol));
            assertTrue ("containsValue7dave", f7.containsValue(dave)); //Changed from Assignment 4 specs
	    ...
	    //Testing removeKey
	    assertTrue("removeKey0one", f0.removeKey(one).equals(FMap.empty()));
	    assertTrue("removeKey1one", f1.removeKey(one).equals(f0));
	    assertTrue("removeKey2one", f2.removeKey(one).equals(f0.put(two,bob)));
	    assertTrue("removeKey2two", f2.removeKey(two).equals(f1));
	    assertTrue("removeKey7two", f7.removeKey(two).equals(f0.put(one,dave)));
	    assertTrue("removeKey8two", f8.removeKey(two).equals(f1));
    
	    //Testing removeValue
	    assertTrue("removeValue0alice", f0.removeValue(alice).equals(FMap.empty()));
	    assertTrue("removeValue1alic", f1.removeValue(alice).equals(f0));
	    assertTrue("removeValue2alice", f2.removeValue(alice).equals(f0.put(two,bob)));
	    assertTrue("removeValue2bob", f2.removeValue(bob).equals(f1));
	    assertTrue("removeValue7dave", f7.removeValue(dave).equals(f8));
	    assertTrue("removeValue9dave", f9.removeValue(dave).equals(f1));
        }
        catch (Exception e) {
    ...
    private void iterators () {
        try {
            ...
            assertFalse ("iteratorSanity", it.hasNext());
            assertTrue ("count9put71", f.size() == count);
